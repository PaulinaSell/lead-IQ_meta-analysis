...
::: {.reply}
Thank you for raising this, we adjusted the wording to clarify that the results show robustness to the alternative priors tested in the sensitivity analysis (see revisions below). Following your second comment, we have added two additional prior sensitivity analyses and would like to gently refer you to our reply to your second comment to see the changes made in the Results -- Sensitivity Analysis section.
:::
...
::: {.reply}
Thank you for raising this, the GitHub repository is now publicly accessible at github.com/PaulinaSell/lead-IQ_meta-analysis.
:::
...
::: {.revision section="Method -- Meta-Analysis -- Frequentist Meta-Analysis"}
...
::: {.reply}
Thank you for this comment, we agree and have added a more explicit statement to the Discussion, emphasizing that the coefficients pooled in our study may not represent exactly the same estimand which complicates the interpretability of the pooled estimate.
:::
...
We removed it and refer readers directly to Table 1, which is now the only source for this information.
:::
