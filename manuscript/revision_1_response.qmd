...
We have updated Section 2.4.1, Section 3.3 and rewritten Additional File 4 accordingly.
:::
...
::: {.reply}
Thank you for catching this. The reviewer is correct that the upper limit was wrong: a coding error caused the point estimate of $\tau^2$ to be printed in place of the upper confidence limit. We have corrected this, and the confidence interval is now reported from the correct bound returned by `metafor`.
:::
